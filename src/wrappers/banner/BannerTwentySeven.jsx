...
import BannerTwentySevenSingle from "../../components/banner/BannerTwentySevenSingle.jsx";

const BannerTwentySeven = ({ spaceBottomClass, spaceTopClass }) => {
  return (
    <div
      className={clsx(
        "banner-area hm9-section-padding",
        spaceTopClass,
        spaceBottomClass
      )}
    >
        ...
        <div className="row">
          {bannerData?.map((single, key) => (
            <div className="col-lg-6 col-md-6" key={key}>
              <BannerTwentySevenSingle data={single} spaceBottomClass="mb-30" />
            </div>
          ))}
        </div>
      </div>
